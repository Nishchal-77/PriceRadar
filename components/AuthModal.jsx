  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md overflow-hidden p-0 gap-0">
        ...
        <div className="-mt-7 rounded-t-3xl bg-card px-6 pb-6 pt-5">
          <DialogHeader>
            <DialogTitle className="text-center text-xl">
              Sign in to continue
            </DialogTitle>
            <DialogDescription className="text-center">
              Track product prices and get AI-powered alerts on price drops
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-4 pt-6">
            <Button
              ...
              variant="outline"
              className="w-full gap-2 h-12 text-base shadow-sm hover:shadow-md hover:border-primary/40 transition-all"
              size="lg"
            >
            ...
            <p className="text-center text-xs text-muted-foreground">
              By continuing, you agree to receive price drop alerts by email.
            </p>
          </div>
        </div>
      </DialogContent>
